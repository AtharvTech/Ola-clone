            ...
            <div class="body">
                <table>
                    <tr>
                        ...
                        <td>Name</td>
                        <td>Phone Number</td>
                        <td>Total Trips Taken</td>
                        <td>Trips Canceled</td>
                    </tr>
                    ...
                    ?>
                      <tr>
                          ...
                          <?php
                          // echo $curr_cust;
                          $csql = "SELECT * FROM `trip` WHERE `user_name` = '$curr_cust_usr' ";
                          ...
                          <td><p>
                            <?php
                             $csql = "SELECT * FROM `trip` WHERE `status` = 'Canceled By Customer' ";
                             $cresult = mysqli_query($conn, $csql);
                             $ccount = mysqli_num_rows($cresult);
                            echo $ccount;
                            ?>
